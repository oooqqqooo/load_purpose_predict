...
list_para = [{'C': 19, 'kernel': 'rbf'}, {'C': 7, 'kernel': 'rbf'}, {'C': 8, 'kernel': 'rbf'}, \
             {'C': 17, 'kernel': 'rbf'}, {'C': 0.2, 'kernel': 'rbf'}, {'C': 19, 'kernel': 'rbf'},\
             {'C': 0.2, 'kernel': 'linear'},{'C': 20, 'kernel': 'rbf'}, {'C': 14, 'kernel': 'rbf'},\
             {'C': 0.2, 'kernel': 'rbf'},{'C': 20, 'kernel': 'rbf'}]
